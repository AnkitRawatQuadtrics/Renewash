...
class ForgotPasswordViewModel:ViewModel() {
    fun forgotPassword(mapData: HashMap<String, String>, view: View, ctx: Context): MutableLiveData<CommonPojo?> {
        ...
        val call: Call<CommonPojo>? = apiInterface.forgotPassword(mapData)
